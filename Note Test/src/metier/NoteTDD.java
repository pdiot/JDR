...
public class NoteTDD {
	...
	public static String note(int exam, int cc) {
		...
		int sum = exam + cc;
		if (exam < 0 || exam > 75) { // On sort de la fonction si on est en dehors de la plage d'entrées valides
			return "Erreur dans exam";
		} 
		else if (cc < 0 || cc > 25) { // On sort de la fonction si on est en dehors de la plage d'entrées valides
