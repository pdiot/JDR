...
public class Exos {
	...
	public static void tp24() {
		...
		System.out.println("Quantité d'articles");
		s = new Scanner (System.in);
		int q = s.nextInt();
		System.out.println("Taux de TVA en %");
		s = new Scanner (System.in);
		double tva = s.nextDouble();
		System.out.println(q + " articles achetés à " + prixHT + "€ avec un taux de TVA de " + tva + "%.");
	...
	public static void tp31(){
		...
		String retour = val <= 0 ? "Négatif" : "Positif";
	...
	public static void tp35(){
		...
		String ret;
		if (x==0 || y == 0) {
			ret = "Le résultat est nul";
		} else if ((x > 0 && y > 0) || (x <0 && y <0)) {
			ret = "Le résultat est positif";
		} else {
			ret = "Le résultat est négatif";
		}
		System.out.println(ret);
	}
	
	public static void tp36() {
		System.out.println("Quel est l'âge de l'enfant ?");
		Scanner s = new Scanner(System.in);
		double age = s.nextDouble();
		String ret = "Aucune catégorie";
		if (age >= 6 && age <= 7) {
			ret = "Poussin";
		} else if (age >=8 && age <= 9){
			ret = "Pupille";
	...
	public static void tp44() {
		System.out.println("Entrer le nombre de copies désirées");
	...
	public static void tp45() {
		...
		System.out.println("Entrer l'âge du Zorglubien");
		s = new Scanner (System.in);
		int age = s.nextInt();
	...
	public static void tp46() {
		...
		if (c2 > 50 || c3 > 50 || c4 > 50) {
			...
			if ((c1 > 12.5) && (c1 > c2 && c1 > c3 && c1 > c4)) {
				...
				System.out.println("Le candidat est en ballotage défavorable");
			}
		}
	}
	...
	public static void tp47() {
		...
		System.out.println("Entrer l'age, la durée de possession du permis, le nombre d'accidents et depuis combien de temps le client est assuré");
		Scanner s = new Scanner (System.in);
		age = s.nextInt();
	...
	public static void tp48() {
		...
		try {
			...
			System.out.println("Erreur dans la date entrée : " + nfe.getMessage());
		}
	}
